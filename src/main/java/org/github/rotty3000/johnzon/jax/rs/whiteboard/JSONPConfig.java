...
@ObjectClassDefinition(
	description = "Configuration for Johnzon JSONP JAX-RS Message Body Reader & Writer",
	name = "Johnzon JAX-RS JSONP",
	pid = JSONPConfig.CONFIG_PID
)
public @interface JSONPConfig {
	public static final String CONFIG_PID = "org.github.rotty3000.johnzon.jax.rs.whiteboard.jsonp";
