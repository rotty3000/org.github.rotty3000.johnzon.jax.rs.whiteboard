...
@ObjectClassDefinition(
	description = "Configuration for Johnzon JAX-RS Message Body Reader & Writer",
	name = "Johnzon JAX-RS",
	pid = JohnzonConfig.CONFIG_PID
)
public @interface JohnzonConfig {
	public static final String CONFIG_PID = "org.github.rotty3000.johnzon.jax.rs.whiteboard.johnzon";

	@AttributeDefinition(description = "List of fully qualified class names to ignore")
	String[] ignores() default {};

	@AttributeDefinition(description = "Target filter for matching the Mapper service")
	String mapper_target() default "(service.id=*)";
